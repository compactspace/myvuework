...
function useBaseQuery(Observer, options, queryClient) {
  ...
  const readonlyState = false ? state : (
    // @ts-expect-error
...
function useQueries({
  ...
  return false ? state : options.shallow ? shallowReadonly(state) : readonly(state);
}
...
function useMutation(mutationOptions, queryClient) {
  ...
  const readonlyState = false ? state : options.value.shallow ? shallowReadonly(state) : readonly(state);
