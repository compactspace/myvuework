...
import { useApllicantStatusUpdateMutation } from "../문법Hook/Applicant/useApllicantStatusUpdateMutation";
import { useApplicantPaginQuery } from "../문법Hook/Applicant/useApplicantPaginQuery";
import Pagination from "../페이징라이브러리/paginateLive.vue";

import sadd from "../../이미지확인용/saddfrog.jpg";
import noSearchImage from "../../이미지확인용/noSearch.png";
